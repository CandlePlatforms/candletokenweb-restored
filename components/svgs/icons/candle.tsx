...
const candleIconSvg = ({ pushSx, isDark }: Props) => (
  <svg
    viewBox="0 0 236 250"
    fill="none"
    ...
    <g mask="url(#candle-svg-mask0)">
      ...
      <g mask="url(#candle-svg-mask1)">
        <g filter="url(#candle-svg-filter0_d)">
          <rect
            x="-583.127"
            y="-37.002"
            width="1464.06"
        ...
        <path
          ...
          fill="url(#candle-svg-paint0_linear)"
        />
        <path
          ...
          fill="url(#candle-svg-paint1_linear)"
        />
        <path
          ...
          fill="url(#candle-svg-paint2_linear)"
        />
        <path
          ...
          fill="url(#candle-svg-paint3_linear)"
        />
      </g>
    </g>
    <defs>
      <filter
        id="candle-svg-filter0_d"
        x="-623.127"
        y="-61.002"
        width="1544.06"
        height="378.474"
