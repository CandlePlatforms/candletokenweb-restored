export const docsPositions = [
  ...
  "docs/installation/install-candle.mdx",
  "docs/installation/install-candle/overview.mdx",
  "docs/installation/install-candle/binary-release.mdx",
  "docs/installation/install-candle/docker.mdx",
  "docs/installation/install-candle/installing-for-development.mdx",
  "docs/installation/configuring-candle.mdx",
