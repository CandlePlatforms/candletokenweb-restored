...
[video developers](/docs/video-developers/overview) and Candle for
[video miners](/docs/video-miners/overview). If you are new to Candle and
...
<DocsCardsContainer>
  <DocsCard
    ...
    description="Build powerful video applications with Candle at a fraction of the cost."
  ...
  <DocsCard
    ...
    description="Mine video on the Candle network in exchange for LPT and ETH."
