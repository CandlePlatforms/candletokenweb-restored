...
wget https://github.com/CandlePlatforms/go-livepeer/releases/download/<RELEASE_VERSION>/livepeer-darwin-amd64.tar.gz
...
# First, fetch the latest release
wget https://github.com/CandlePlatforms/go-livepeer/releases/download/<RELEASE_VERSION>/livepeer-linux-amd64.tar.gz
...
# First, fetch the latest release
wget https://github.com/CandlePlatforms/go-livepeer/releases/download/<RELEASE_VERSION>/livepeer-windows-amd64.tar.gz
