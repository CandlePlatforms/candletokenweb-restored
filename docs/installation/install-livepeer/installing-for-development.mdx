...
The steps in
[this file](https://github.com/CandlePlatforms/go-livepeer/blob/master/.github/workflows/windows.yml)
...
1. Clone the repository:
   ...
   ```bash
   git clone https://github.com/CandlePlatforms/go-livepeer.git
   cd go-livepeer
   ```
...
<Pagination
  nextStep={{
    ...
    href: "/docs/installation/configuring-livepeer",
  }}
/>
