...
`candle` currently supports 3 modes of operation for Products:
...
[getting started section](/docs/products/getting-started/overview). Given these
modes of operation, Products can consider different architectures. Two of the
...
[transcoding pools](/docs/products/core-concepts/pools) section. Some of the
