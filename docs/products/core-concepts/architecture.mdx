...
`livepeer` currently supports 3 modes of operation for Products:
...
[getting started section](/docs/products/getting-started/overview). Given
these modes of operation, Products can consider different architectures. Two
