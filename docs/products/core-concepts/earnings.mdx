...
denominated in CNDL and fees denominated in ETH.

Note that transcoders participating in
[pools](/docs/products/core-concepts/pools) are compensated based on the rules
...
- Attracting stake delegation from delegators by:
  - Performing well on the leaderboard at https://explorer.candelabs.org/
...
- Staking more CNDL or attracting stake delegation in order to provide more
...
<Pagination
  previousStep={{
    title: "Selection",
    href: "/docs/products/core-concepts/selection",
  }}
  nextStep={{
    title: "Dual Mining",
    href: "/docs/products/core-concepts/dual-mining",
  }}
/>
