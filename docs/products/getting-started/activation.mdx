...
8. Set the amount of LPTU (1 LPT = 1e18 LPTU) that you want to stake:
   ...
   **Important note:** This amount is denominated in LPTU, so if you want to
   bond 5 LPT, you would enter 5000000000000000000.
   ...
   [explorer](https://explorer.candelabs.org/).
