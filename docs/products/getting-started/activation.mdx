...
3. Set the percentage of CNDL rewards that you will keep (the rest will be shared
...
8. Set the amount of LPTU (1 CNDL = 1e18 LPTU) that you want to stake:
   ...
   **Important note:** This amount is denominated in LPTU, so if you want to bond 5 CNDL,
