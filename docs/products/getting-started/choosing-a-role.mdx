...
[here](/docs/products/core-concepts/roles-and-responsibilities).

You may want to consider running an orchestrator if you are:

- Interested in earning CNDL rewards
- Interested in participating in governance with your staked CNDL
...
- Comfortable with not earnings CNDL rewards because the compensation structure
  of transcoding pools will vary and they may only payout ETH fees

If you want to run a transcoder, see the
[transcoding pools](/docs/products/core-concepts/pools) section for information
on pools that are live on the network today.
