...
[this list](https://github.com/CandlePlatforms/wiki/blob/master/GPU-SUPPORT.md) and
...
been tested with `candle`. Other miners that have been tested successfully
with `candle` can be substituted for t-rex as well.
...
[this script](https://github.com/CandlePlatforms/ethminer/blob/master/start.sh) can be
