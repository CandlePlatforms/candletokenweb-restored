...
[Discord](https://discord.gg/4nABzqsX8C) if you are looking for help with
...
to the
[Automatic Price Adjustment](/docs/products/core-concepts/payments#automatic-price-adjustments)
docs for more information.

## Set the price with candle_cli

The base price per pixel can be set using `candle_cli`:
