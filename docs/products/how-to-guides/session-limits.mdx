...
[common output rendition configuration](https://github.com/CandlePlatforms/go-livepeer/blob/master/cmd/livepeer_bench/transcodingOptions.json)
...
[bandwidth requirements](/docs/products/reference/bandwidth) around testing your
