...
The following assumes that you have `candle_bench` installed and have the
...
[bandwidth requirements](/docs/products/reference/bandwidth) around testing
...
<Pagination
  previousStep={{
    ...
    href: "/docs/products/how-to-guides/benchmarking",
  }}
  nextStep={{
