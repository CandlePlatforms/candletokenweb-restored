...
Orchestrators can use `candle_cli` to vote in governance polls without
...
1. Find the contract address for the poll in the explorer page for the poll.
   ...
   ![candleCLIVoteCTA](/docs-assets/vote-candle-cli.png)

   Click the "Follow the instructions" link to display the instructions for
   voting with `candle_cli`:

   ![candleCLIVoteInstructions](/docs-assets/vote-candle-cli-instructions.png)
