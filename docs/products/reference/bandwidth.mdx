...
The bandwidth requirements for Products are based on the amount of video
...
While there is not a strict bandwidth requirement for Products, past testing
...
<Pagination
  previousStep={{
    ...
    href: "/docs/products/reference/hardware",
  }}
  nextStep={{
    title: "Performance Leaderboard",
    href: "/docs/products/reference/leaderboard",
  }}
/>
