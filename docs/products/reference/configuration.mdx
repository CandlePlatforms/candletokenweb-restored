...
[this file](https://github.com/CandlePlatforms/go-livepeer/blob/master/cmd/livepeer/livepeer.go).
The
[go-livepeer developer docs](https://github.com/CandlePlatforms/go-livepeer/tree/master/doc)
