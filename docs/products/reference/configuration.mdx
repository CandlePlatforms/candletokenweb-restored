...
`candle` has a number of configurable options. You can
[set your configuration using command-line flags, environment variables, or a config file](/docs/installation/configuring-candle).

A comprehensive list of options can be found below. They are sourced and
regularly updated from
[this file](https://github.com/CandlePlatforms/go-candle/blob/master/cmd/candle/candle.go).
The
[go-candle developer docs](https://github.com/CandlePlatforms/go-candle/tree/master/doc)
...
metadataAmqpExchange: Name of AMQP exchange to send operation metadata. Default `lp_gocandle_metadata`
...
<Pagination
  ...
  nextStep={{
    ...
    href: "/docs/products/reference/hardware-requirements",
  }}
/>
