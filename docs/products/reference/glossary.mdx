...
Orchestrators are Products that are responsible for receiving video from
...
Transcoders are Products that are responsible for transcoding video. They
perform work on the network.

## Stake

Stake is CNDL that is locked in the Candle smart contracts. Orchestrators are
