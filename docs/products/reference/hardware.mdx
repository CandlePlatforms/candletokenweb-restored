...
The hardware requirements for Products are based on the computational resources
...
Currently, `candle` only supports Nvidia GPUs with
...
by `candle`, see
[this page](https://github.com/CandlePlatforms/wiki/blob/master/GPU-SUPPORT.md).
