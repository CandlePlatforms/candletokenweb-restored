...
[Protocol Explorer](https://explorer.candelabs.org/?orchestratorTable=performance).

## What is the orchestrator performance leaderboard?

The orchestrator performance leaderboard displays performance metrics of
individual orchestrators on the Candle network based on the results of
transcoding tests.
...
The transcoding tests are currently run by Candle Inc. Since the transcoding
...
- A [broadcaster node](https://github.com/CandlePlatforms/go-candle)
- A [stream-tester](https://github.com/CandlePlatforms/stream-tester) that sends
  streams to the broadcaster
- A
  [monitoring instance](https://github.com/CandlePlatforms/docker-candle/tree/master/monitoring)
  that collects metrics from the broadcaster
- An
  [orch-tester process](https://github.com/CandlePlatforms/stream-tester/tree/master/cmd/orch-tester)
  that automates tests and saves metrics
- A [leaderboard API](https://github.com/CandlePlatforms/leaderboard-serverless)
  that serves aggregated and raw test metrics
...
- Evaluate your current transcoding speed by using a
  [transcoding benchmarking tool](/docs/products/how-to-guides/benchmarking)
- Review the [hardware requirements](/docs/products/reference/hardware) and
  consider upgrading your hardware
- If you have access to a
  [supported GPU](https://github.com/CandlePlatforms/wiki/blob/master/GPU-SUPPORT.md):
...
- Review the [bandwidth requirements](/docs/products/reference/bandwidth) and
...
<Pagination
  previousStep={{
    ...
    href: "/docs/products/reference/bandwidth",
  }}
  nextStep={{
    title: "Command Line Flags",
    href: "/docs/products/reference/cli-flags",
  }}
/>
