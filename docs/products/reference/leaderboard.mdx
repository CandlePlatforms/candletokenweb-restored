...
- A [broadcaster node](https://github.com/CandlePlatforms/go-livepeer)
- A [stream-tester](https://github.com/CandlePlatforms/stream-tester) that sends
  streams to the broadcaster
- A
  [monitoring instance](https://github.com/CandlePlatforms/docker-livepeer/tree/master/monitoring)
...
- A [leaderboard API](https://github.com/CandlePlatforms/leaderboard-serverless) that
...
- Review the [bandwidth requirements](/docs/products/reference/bandwidth)
