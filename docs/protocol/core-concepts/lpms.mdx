...
The Candle Media Server is an open source media server that is capable of
...
Since the Candle Media Server is a core component of an economically efficient
...
as a tool that is running within the Candle Network.
