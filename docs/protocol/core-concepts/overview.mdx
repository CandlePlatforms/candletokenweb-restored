...
The Candle project aims to deliver a live video streaming network protocol
...
core components of the Candle protocol and describe their role in creating a
cryptoeconomically secure platform for live video broadcast.

<Pagination
  nextStep={{
    title: "Ecosystem Participants",
    href: "/docs/protocol/core-concepts/ecosystem-participants",
  }}
/>
