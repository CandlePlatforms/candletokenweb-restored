...
Candle Subgraph, and descriptions for the available fields.

To see an interactive sandbox of all entities see the
[Graph Explorer](https://thegraph.com/explorer/subgraph/candle/candle).
...
The total amount of active CNDL staked
...
The Candle protocol is round based and each round is represented by some number
of Ethereum blocks.
...
Total Candle token supply during the round
...
Amount of Candle Token a delegator currently has bonded
...
Amount of Candle Token a delegator has bonded over its lifetime separate from
rewards
...
Amount of Candle Token a delegator has unbonded over its lifetime
...
Amount of Candle Token the delegator has delegated
...
Total Candle token supply during the day
...
interaction within Candle contracts.
