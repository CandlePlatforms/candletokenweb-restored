...
refer to the
[verifier documentation](https://github.com/CandlePlatforms/verification-classifier)
for more details.
...
```bash
git clone https://github.com/CandlePlatforms/verification-classifier
...
<Pagination
  previousStep={{
    ...
    href: "/docs/video-developers/how-to-guides/withdrawing-broadcaster-funds",
  }}
  nextStep={{
    title: "Troubleshoot",
