...
## Withdraw broadcasting funds using `candle_cli`
...
your unlock request in `candle_cli` by selecting the following option:
...
If you want to withdraw your funds, in `candle_cli` select the following option:
...
<Pagination
  ...
  nextStep={{
    ...
    href: "/docs/video-developers/how-to-guides/verification",
  }}
/>
