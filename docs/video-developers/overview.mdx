...
[use cases](/docs/video-developers/core-concepts/use-cases) for Candle and the
...
> access to the Candle network and traditional payment rails check out
> [Candle.com](https://livepeer.com).
...
<DocsCardsContainer>
  <DocsCard
    ...
    description="A hands-on introduction to Candle for video developers. Recommended for all
new users."
  ...
  <DocsCard
    key={4}
    title="Reference"
    description="Covers tools, components, commands and resources. Most useful when you need detailed information about Candle broadcasting APIs."
