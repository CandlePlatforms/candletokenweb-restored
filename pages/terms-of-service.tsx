...
const headProps: HeadProps = {
  meta: {
    ...
    url: "https://candle.org/privacy-policy",
    siteName: "Candle.org",
...
const PrivacyPolicyPage = () => (
  <PageLayout headProps={headProps} footerProps={{ prefooter: null }}>
    <Container sx={{ py: 5, maxWidth: "800px", p: { mb: 4, lineHeight: 1.7 } }}>
      ...
      <Heading as="h2" variant="heading.5" sx={{ textAlign: "left", mb: 4 }}>
        Interpretation and Definitions
      </Heading>
      <Heading as="h3" variant="heading.6" sx={{ textAlign: "left", mb: 4 }}>
        Interpretation
      </Heading>
      <Text as="p">
      ...
      <Text as="p">For the purposes of these Terms and Conditions:</Text>
      <ul>
        <li>
          <Text as="p">
      ...
      <ul>
        <li>By email: contact@candle.org</li>
      </ul>
    </Container>
  </PageLayout>
);
